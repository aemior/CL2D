#ifndef HALIDE________quant_ori_h
#define HALIDE________quant_ori_h
#include <stdint.h>
...
int quant_ori(double _thr, struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_quantori_buffer, struct halide_buffer_t *_mag_out_buffer) HALIDE_FUNCTION_ATTRS;
int quant_ori_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *quant_ori_metadata() HALIDE_FUNCTION_ATTRS;
